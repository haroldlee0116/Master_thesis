%%  Experiment 4: Compare with TN based framework
%   In this experiment, we compare the identification performances between 
%   my framework and other three Tensor Network based frameworks [2,3] on the 
%   sythenic MISO Volterra datasets. When the budget is activated, the
%   maximal rank for [2] is applied in line 84; for ALS in [3] is in line 
%   120, and for MAlS in [3] is in line 111 of file 'mvmals2'.

%   My framework use the KRT-structured LSCPDS [1] routines
...
%   [3] Kim Batselier, Zhongming Chen, and Ngai Wong. “Tensor Network 
%   alternating linear scheme for MIMO Volterra system identification”. 
%   In: Automatica 84 (2017), pp. 26–35.

close all; clear variables; clc; 
NOISE_ON = 1; % if noise is on, use 1 here; different SNR is looped in line 44 
%% System generation
d=3;
p=1;
l=1;
